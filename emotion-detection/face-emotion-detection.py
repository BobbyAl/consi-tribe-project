...
def main():
    ...
    output_path = os.path.join(base_directory, "data", "face_emtions.json")
    ...
    while capture.isOpened():
        ...
        current_time = capture.get(cv2.CAP_PROP_POS_MSEC) / 1000.0                                  # current timestamp 
    ...
    df_averaged.index = df_averaged.index.astype(str)
    face_dict = df_averaged.to_dict(orient="index")

    with open(output_path, "w") as f:
        json.dump(face_dict, f, indent=4)
