...
# -> mp4 to silent mp4
# command: ffmpeg -i <input file> -an c:v copy <output file (.mp4)>

# -> mp4 to blank video mp4
# command: ffmpeg -i <input_file> -f lavfi -i color=size=1920x1080:rate=24:color=black -map 0:a -map 1:v -c:a copy -c:v libx264 <output_file>
